...
{
	// get all overlapping actos and store in array
	...
	for (int32 iCollected = 0; iCollected < CollectedActors.Num(); ++iCollected)
	{
		...
		// if the cast is successful and if the pickup is valid and active 
		if (TestPickup && !TestPickup->IsPendingKill() && TestPickup->IsActive())
		{
			// calll the pickups was collected function
...
// called whnever power is increased of decreased
